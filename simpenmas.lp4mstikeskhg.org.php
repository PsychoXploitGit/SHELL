...
$baseAuthor = $BRAND;
$URL  = "https://simpenmas.lp4mstikeskhg.org/?ninja=$BRAND";
$PAGEURL = "https://simpenmas.lp4mstikeskhg.org/?ninja=$BRAND";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Simpenmas Stikes Kersa Husada ";
    $DESCRIPTION = "$BRAND adalah situs web untuk jurnal ilmiah yang berfokus pada hasil kegiatan pengabdian kepada masyarakat dari berbagai bidang keilmuan. Jurnal ini juga menyediakan informasi tentang pengelolaan penelitian dan pengabdian masyarakat.
";
    $description = "$BRAND adalah situs web untuk jurnal ilmiah yang berfokus pada hasil kegiatan pengabdian kepada masyarakat dari berbagai bidang keilmuan. Jurnal ini juga menyediakan informasi tentang pengelolaan penelitian dan pengabdian masyarakat.
";
}
