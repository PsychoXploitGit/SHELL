...
$baseAuthor = $BRAND;
$URL  = "https://pdk.unand.ac.id/?ninja=$BRAND";
$PAGEURL = "https://pdk.unand.ac.id/?ninja=$BRAND";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Pdk Universitas Andalas ";
    $DESCRIPTION = "$BRAND adalah situs resmi UPT PDK Universitas Andalas, yang berfokus pada pembelajaran di luar kampus. Situs ini menyediakan informasi tentang program, sejarah, dan kegiatan yang mendukung pengembangan mahasiswa.
";
    $description = "$BRAND adalah situs resmi UPT PDK Universitas Andalas, yang berfokus pada pembelajaran di luar kampus. Situs ini menyediakan informasi tentang program, sejarah, dan kegiatan yang mendukung pengembangan mahasiswa.
";
}
