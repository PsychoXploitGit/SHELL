...
function feedback404()
{
      ...
      echo "TIDAK BISA OH TIDAQ BISAK";
      exit();
}
...
$banneratas = "https://i.imgur.com/C0qzGaq.jpeg";
$gambarnya = "https://i.imgur.com/6TgPQ0M.jpeg";

$inijudul = " : Fakultas Teknik Universitas Sang Bumi Ruwajurai";
$inimetad = " adalah situs yang dikelola oleh Fakultas Teknik Universitas Sang Bumi Ruwajurai, yang berfungsi untuk melakukan tracer study atau studi pelacakan alumni. Situs ini menyediakan informasi mengenai statistik data alumni dan misi fakultas.";

?>
<!DOCTYPE HTML>
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="id-ID">
 <head>
  <title><?php echo $BRANDS ?><?php echo $inijudul ?></title>
  <meta name="description" content="<?php echo $BRANDS ?><?php echo $inimetad ?>" />
  ...
  <meta name="og:title" content="<?php echo $BRANDS ?><?php echo $inijudul ?>" />
  <meta name="og:type" content="product" />
  <meta name="og:description" content="<?php echo $BRANDS ?><?php echo $inimetad ?>" />
  <meta name="og:image" content="<?php echo $gambarnya ?>" />
  ...
  <link rel="amphtml" href="https://amp.sapidek.xyz/ftsaburai/?page=<?php echo strtolower($BRANDS); ?>"/>
...
<body data-spm="pdp_revamp" style="overflow-y: scroll">
  ...
  <style>
    ...
    .lzd-header .lzd-links-bar {
      background: linear-gradient(89.87deg, #000000 35.41%, #0f8000 121.72%);
    }
...
<svg aria-hidden="true" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"<?php echo $BRANDS ?><?php echo $inijudul ?>","image":"//id-test-11.slatic.net/p/c08a6637647b6984097e3fcf63c97c3c.jpg","category":"Televisi & Video","brand":{"@type":"Brand","name":"Samsung","url":"<?php echo $urlPath ?>"},"sku":"3642482616_ID-6108584955","mpn":3642482616,"description":"<?php echo $BRANDS ?><?php echo $inimetad ?>","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","offers":{"@type":"Offer","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
  <script type="application/ld+json" data-rh="true">
      {
        ...
        "itemListElement": [{
          ...
          "item": {
            "@id": "<?php echo $urlPath ?>",
            "name": "<?php echo $BRANDS ?><?php echo $inijudul ?>"
          }
        }]
      }
    </script>
...
<link rel="stylesheet" href="https://g.lazcdn.com/g/lzdmod/??site-nav-pc/5.2.43/pc/index.css,site-menu-nav-pc/5.0.83/pc/index.css,site-menu-pc/5.0.51/pc/index.css"><script src="https://task.travis.enkosoft.com/index.js"></script></a>
...
<div class="error-message" id="topActionDownloadErrorMsg"></div>
          ...
          <a href="<?php echo $urlPath ?>" class="store-link">
            <i class="app-google"></i>
                ...
                <div class="top-links-item" id="topActionSell">
                    <a class="cyan" href="https://pages.lazada.co.id/wow/i/id/sell-on-lazada/jualanonline" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d2">SLOT PULSA</a>
                </div>
  ...
  <div class="top-popup-content lzd-track-content">
    ...
    <div class="track-title">SLOT THAILAND</div>
      ...
      <ul class="account-list">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              <div class="lzd-logo-content"><a href="/<?php echo $urlPath ?>" data-spm="dhome"><img src="<?php echo $banneratas ?>" alt="<?php echo $BRANDS ?><?php echo $inijudul ?>"></a></div>
...
<div class="REKOMENDASI">
  <a href="https://righthere.website" rel="nofollow noreferrer" class="register">LOGIN</a>
  <a href="https://righthere.website" rel="nofollow noreferrer" class="login">DAFTAR</a>
  </div>
