...
$baseAuthor = $BRAND;
$URL  = "https://jurnal.uisu.ac.id/?ninja=$BRAND";
$PAGEURL = "https://jurnal.uisu.ac.id/?ninja=$BRAND";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Jurnal Online Universitas Islam Sumatera Utara ";
    $DESCRIPTION = "$BRAND adalah platform publikasi jurnal online yang dikelola oleh Universitas Islam Sumatera Utara. Jurnal ini mencakup berbagai bidang ilmu dan bertujuan untuk mengembangkan serta mendokumentasikan penelitian akademik.
";
    $description = "$BRAND adalah platform publikasi jurnal online yang dikelola oleh Universitas Islam Sumatera Utara. Jurnal ini mencakup berbagai bidang ilmu dan bertujuan untuk mengembangkan serta mendokumentasikan penelitian akademik.
";
}
