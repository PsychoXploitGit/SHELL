...
$baseAuthor = $BRAND;
$URL  = "https://uigm.ulm.ac.id/?ninja=$BRAND";
$PAGEURL = "https://uigm.ulm.ac.id/?ninja=$BRAND";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # UIGM ULM - Universitas Islam Guru Muhammad Banjarmasin ";
    $DESCRIPTION = "$BRAND UIGM (Universitas Islam Guru Muhammad) di bawah ULM Banjarmasin menyediakan program studi unggulan dengan kurikulum berbasis keislaman dan modern. Daftar sekarang!
";
    $description = "$BRAND UIGM (Universitas Islam Guru Muhammad) di bawah ULM Banjarmasin menyediakan program studi unggulan dengan kurikulum berbasis keislaman dan modern. Daftar sekarang!
";
}
